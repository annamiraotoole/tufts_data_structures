...
{
        // TODO:  Student fills this in (and deletes this comment)
        // Note:  copy_array() function below might be handy
    if (current_capacity >= desired_capacity)
        return;
    else {
        ElemType *newData = new ElemType[desired_capacity];
        copy_array(data, newData, current_size);
        delete data;
        data = newData;
        // question: do I have to worry about dropping my "newData" pointer?
    }
