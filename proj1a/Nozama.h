...
class Nozama {
 ...
 private:
    ...
    Orderqueue fetchers[1]; // queue of items left to be fetched, initialized with size 1
    Orderqueue packers[1]; // array of queues containing items to be packed, initialized with size input from command line
